...
const BRAND_CHARS = 'MINDHEALTH'.split('')
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-24 relative z-10">
                    ...
                    >
                        ...
                        <div id="solution" className="flex flex-col gap-6">
                            ...
                            <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.58)', lineHeight: 1.85, maxWidth: 480 }}>
                                MindHealth fuses all four modalities into a single severity score — giving you the accuracy of a clinical multi-session assessment in under two minutes.
                            </p>
                ...
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-14 relative z-10">
                    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="flex flex-col items-center gap-5">
                        ...
                        <p className="at-body" style={{ fontSize: 15, color: 'rgba(203,213,225,0.55)', lineHeight: 1.85, maxWidth: 480 }}>
                            Mental health is deeply personal. MindHealth is engineered from the ground up to keep your sessions private, your data secure, and your identity protected.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-10">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 py-12" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="font-display" style={{ fontSize: 14, fontWeight: 700, color: '#f0f0f0', letterSpacing: '0.04em' }}>MINDHEALTH</span>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6">
                        <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.22)', letterSpacing: '0.03em' }}>
                            © 2026 MindHealth — Smart Mental Health Counselling System
                        </span>
                        <div className="flex items-center gap-6">
                            {[
                                { label: 'Privacy Policy', message: 'MindHealth ensures 100% data privacy. Your session data is end-to-end encrypted and never stored permanently.' },
                                { label: 'Terms of Use', message: 'By using MindHealth, you agree to our terms. Please note: This is an AI support tool and not a substitute for clinical medical advice.' },
                                { label: 'Contact', message: 'Need help? Reach out to our mental health support team at support@mindhealth.com' }
                            ].map(item => (
