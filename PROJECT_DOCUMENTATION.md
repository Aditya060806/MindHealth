...
- **Functionality:** A natural, conversational interface using an empathetic AI Persona ("MindHealth").
...
- **Features:** 
  ...
  - **Dr. MindHealth Bot:** A secondary fallback conversational agent strictly for post-assessment daily check-ins.
