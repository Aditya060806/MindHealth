...
<img src="https://img.shields.io/badge/MindHealth-Smart%20Mental%20Health%20Counselling-00f5ff?style=for-the-badge&logo=brain&logoColor=white" alt="MindHealth" />
...
<div align="center">
  <em>▶ MindHealth - Complete Project Walkthrough (Click Play to watch)</em>
</div>
...
**MindHealth** solves this by combining **four independent AI modalities** into a single, unified platform. Rather than relying on one signal, the system fuses insights from:
...
- **Frontend Application (Vercel):** [MindHealth Web App](https://smart-mental-health-counselling-sys.vercel.app)
...
- **Dr. MindHealth Chatbot** — An empathetic AI therapist powered by OpenRouter
...
│  WebGL BG    JWT Tokens      (Behaviour, Chat,   Dr. MindHealth Bot │
...
│   │   └── dashboard.py            # Dashboard data, tasks, Dr. MindHealth chat
...
```bash
git clone https://github.com/Aditya060806/MindHealth.git
cd MindHealth
```
...
| `POST` | `/dashboard/doctor-chat` | Chat with Dr. MindHealth bot | ✅ |
...
| `doctor_chat_messages` | Dr. MindHealth AI therapist conversation history |
...
| **Dashboard** | `/dashboard` | Main wellness hub with charts, tasks, Dr. MindHealth, and video recommendations |
| **Profile** | `/dashboard` | Edit demographics, password change, view account creation date |

---

Here is a glimpse of the MindHealth platform in action:
...
*MindHealth — Because your mind matters.*
