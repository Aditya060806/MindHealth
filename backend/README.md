...
This is the **REST API backend** for the MindHealth platform — a multimodal mental health counselling system that analyses a user's **facial emotion**, **voice mood**, **behavioural patterns**, and **natural language** to generate a personalised mental wellness assessment and AI-driven counselling experience.
...
This project is developed as part of an academic research initiative. All rights reserved © 2026 MindHealth.
